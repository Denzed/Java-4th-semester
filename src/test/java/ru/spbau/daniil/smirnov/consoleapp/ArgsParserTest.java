...
import ru.spbau.daniil.smirnov.testing.TestWithTemporaryFolder;
...
public class ArgsParserTest extends TestWithTemporaryFolder {
    ...
    public void parseBranchTest() throws Exception {
        ...
        final String[] argsToCheckoutBackToMaster = {"checkout", "master"};
        parser.parse(argsToCheckoutBackToMaster);
    ...
    public void parseMergeTest() throws Exception {
        ...
        final String[] args = {"merge", "master"};
        parser.parse(args);
    }
}