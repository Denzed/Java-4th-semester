...
public class Commit implements Serializable, Comparable<Commit> {
    ...
    private Commit(@NotNull String rootTreeHash, @NotNull String commitMessage, @NotNull String commitAuthor, @NotNull Date creationDate, @NotNull List<String> parentCommitsHashes) {
